...
const products = [
  { name: "Organic Fuji Apple", price: 5.99, img: "https://images.unsplash.com/photo-1560806887-1e4cd0b6faa6?auto=format&fit=crop&q=80&w=600", rating: 4.8, reviews: 124, category: "Fruits" },
  { name: "Farm Fresh Eggs", price: 3.99, img: "https://images.unsplash.com/photo-1506976785307-8732e854ad03?auto=format&fit=crop&q=80&w=600", rating: 4.9, reviews: 89, category: "Dairy" },
  { name: "Hass Avocado", price: 2.50, img: "https://images.unsplash.com/photo-1523049673857-eb18f1d7b578?auto=format&fit=crop&q=80&w=600", rating: 4.7, reviews: 210, category: "Vegetables" },
  { name: "Premium Grass-Fed Beef", price: 12.99, img: "https://images.unsplash.com/photo-1603048297172-c92544798d5e?auto=format&fit=crop&q=80&w=600", rating: 5.0, reviews: 56, category: "Meat" },
];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {products.map((product, index) => (
            <motion.div 
              ...
              className="group bg-white rounded-[2rem] border border-gray-100 shadow-sm hover:shadow-2xl transition-all duration-500 overflow-hidden relative"
            >
              {/* Floating Action Bar */}
              ...
              <div className="h-64 p-0 flex items-center justify-center bg-gray-50 relative overflow-hidden">
              ...
              <div className="p-6 pt-2">
                ...
                <h3 className="font-bold text-xl text-dark mb-1 leading-tight group-hover:text-primary transition-colors">{product.name}</h3>
                ...
                <div className="flex justify-between items-end mt-6">
                  ...
                  <button className="w-12 h-12 rounded-full bg-dark text-white flex items-center justify-center hover:bg-primary transition-colors shadow-lg group-hover:shadow-primary/30">
                    <Plus size={24} />
                  </button>
                </div>
              </div>
